...
export function VisualizationsPage() {
  ...
  const handleLoad = async () => {
    ...
    toast.loading("Parsing resume...", { id: "viz" });
    try {
        ...
        <Card>
          <CardContent className="flex flex-wrap items-end gap-4 p-4">
            <div className="flex-1 space-y-1">
              ...
              <select value={selectedResumeId} onChange={(e) => { setSelectedResumeId(e.target.value); setPreview(null); }}
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-xl bg-brand-50 p-3 text-center dark:bg-brand-900/20">
                    ...
                    <p className="text-2xl font-bold text-brand-600">{preview.wordCount}</p>
                  ...
                  <div className="rounded-xl bg-green-50 p-3 text-center dark:bg-green-900/20">
                    ...
                    <p className="text-2xl font-bold text-green-600">{preview.sections.length}</p>
                  ...
                  <div className="rounded-xl bg-purple-50 p-3 text-center dark:bg-purple-900/20">
                    ...
                    <p className="text-2xl font-bold text-purple-600">{preview.highlights.techKeywords.length}</p>
                  ...
                  <div className="rounded-xl bg-pink-50 p-3 text-center dark:bg-pink-900/20">
                    ...
                    <p className="text-2xl font-bold text-pink-600">{preview.highlights.softSkills.length}</p>
                ...
                <div className="rounded-xl bg-gradient-to-r from-brand-50 to-purple-50 p-4 dark:from-brand-900/20 dark:to-purple-900/20">
                  ...
                  <p className="text-lg font-bold text-brand-600">{preview.industryClassification.primary}</p>
            ...
            <CardHeader>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {([
                    { key: "tech" as const, label: "Tech Skills", color: "#6366f1", count: preview.highlights.techKeywords.length, icon: Code2 },
                    { key: "soft" as const, label: "Soft Skills", color: "#22c55e", count: preview.highlights.softSkills.length, icon: Heart },
                    { key: "verbs" as const, label: "Action Verbs", color: "#f59e0b", count: preview.highlights.actionVerbs.length, icon: Zap },
                    { key: "dynamic" as const, label: "NLP Detected", color: "#ec4899", count: preview.highlights.dynamicSkills.length, icon: Sparkles },
                  ]).map((h) => (
                    <button key={h.key}
